...
const { isUrl, getGroupAdmins, generateMessageTag, getBuffer, getSizeMedia, fetchJson, sleep, getTypeUrlMedia, color, imageToWebp, videoToWebp, writeExif } = require('../lib/myfunction');
...
async function MessagesUpsert(sock, message, store) {
  try {
    ...
    // ⚠️ JANGAN return hanya karena story tidak punya message
    ...
    console.log('MessagesUpsert error:', e)
  }
}
